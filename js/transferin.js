if("undefined"==typeof jQuery)throw new Error("Transfer In's JavaScript requires jQuery");
function newdata()
{
	jQuery.ajax({'url':'transferin/create','data':{},
...
{
	jQuery.ajax({'url':'transferin/createtransstockdet','data':{},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
      ...
      $("input[name='qtyreceipt']").val(data.qtyreceipt);
...
{
	jQuery.ajax({'url':'transferin/update','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'transferin/updatetransstockdet','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
function savedata()
{
	...
	jQuery.ajax({'url':'transferin/save',
		'data':{
...
function savedatatransstockdet()
{
	...
	jQuery.ajax({'url':'transferin/savetransstockdet',
		'data':{
			'transstockid':$("input[name='transstockid']").val(),
      ...
      'qtyreceipt':$("input[name='qtyreceipt']").val(),
...
function approvedata($id)
{
	...
	jQuery.ajax({'url':'transferin/approve',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','Are you sure ?',function(){	
	jQuery.ajax({'url':'transferin/delete',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','Are you sure ?',function(){
	jQuery.ajax({'url':'transferin/purge','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	$.msg.confirmation('Confirm','Are you sure ?',function(){
	jQuery.ajax({'url':'transferin/purgetransstockdet','data':{'id':$.fn.yiiGridView.getSelection("transstockdetList")},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
+ '&slocfromcode='+$("input[name='dlg_search_slocfromcode']").val()
+ '&sloctocode='+$("input[name='dlg_search_sloctocode']").val();
	window.open('transferin/downpdf?'+array);
}
...
+ '&slocfromcode='+$("input[name='dlg_search_slocfromcode']").val()
+ '&sloctocode='+$("input[name='dlg_search_sloctocode']").val();
	window.open('transferin/downxls?'+array);
}
