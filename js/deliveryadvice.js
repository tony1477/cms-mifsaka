...
function newdata()
{
	jQuery.ajax({'url':'deliveryadvice/create','data':{},
...
{
	jQuery.ajax({'url':'deliveryadvice/createdeliveryadvicedetail','data':{},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'deliveryadvice/update','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'deliveryadvice/updatedeliveryadvicedetail','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
			$("input[name='deliveryadvicedetail_1_deliveryadvicedetailid']").val(data.deliveryadvicedetailid);
...
function savedata()
{
	...
	jQuery.ajax({'url':'deliveryadvice/save',
		'data':{
...
function savedatadeliveryadvicedetail()
{
	...
	jQuery.ajax({'url':'deliveryadvice/savedeliveryadvicedetail',
		'data':{
			'deliveryadviceid':$("input[name='deliveryadvice_0_deliveryadviceid']").val(),
...
function approvedata($id)
{
	...
	jQuery.ajax({'url':'deliveryadvice/approve',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','Apakah anda yakin ?',function(){	
	jQuery.ajax({'url':'deliveryadvice/delete',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','Apakah anda yakin ?',function(){
	jQuery.ajax({'url':'deliveryadvice/purge','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	$.msg.confirmation('Confirm','Apakah anda yakin ?',function(){
	jQuery.ajax({'url':'deliveryadvice/purgedeliveryadvicedetail','data':{'id':$.fn.yiiGridView.getSelection("deliveryadvicedetailList")},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
+ '&username='+$("input[name='dlg_search_username']").val()
+ '&sloccode='+$("input[name='dlg_search_sloccode']").val();
	window.open('deliveryadvice/downpdf?'+array);
}
...
+ '&username='+$("input[name='dlg_search_username']").val()
+ '&sloccode='+$("input[name='dlg_search_sloccode']").val();
	window.open('deliveryadvice/downxls?'+array);
}
