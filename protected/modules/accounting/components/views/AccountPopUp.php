<?php
	$sqldata="select accountid,accountname,accountcode,companyname
		from account a
		join company b on b.companyid=a.companyid
		where a.recordstatus = 1  and accountname like '%".(isset($_REQUEST['accountname'])?$_REQUEST['accountname']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'accountid', 'accountname','accountcode','companyname'
        ),
				'defaultOrder' => array( 
