<?php
	$sqldata="select distinct a.ekspedisiid,a.ekspedisino 
		from ekspedisi a 
		...
		where a.recordstatus > 1 
			...
			and a.ekspedisino like '%".(isset($_REQUEST['ekspedisino'])?$_REQUEST['ekspedisino']:'')."%' 
			";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'ekspedisino':$("input[name='<?php echo $this->IDField?>_search_ekspedisino']").val(),
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->IDField?>_search_ekspedisino"><?php echo $this->getCatalog('ekspedisino') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->IDField?>_search_ekspedisino" class="form-control">
					<span class="input-group-btn">
