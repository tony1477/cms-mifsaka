<?php
	$sqldata="select accounttypeid,accounttypename  
		from accounttype 
		where recordstatus = 1 and accounttypename like '%".(isset($_REQUEST['accounttypename'])?$_REQUEST['accounttypename']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'accounttypename':$("input[name='<?php echo $this->ColField; ?>_search_accounttypename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_accounttypename"><?php echo $this->getCatalog('accounttypename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_accounttypename" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('accounttypeid'),
						'name'=>'accounttypeid', 
