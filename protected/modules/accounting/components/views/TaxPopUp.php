<?php
	$sqldata="select taxid,taxcode,taxvalue,description
		from tax a
		where a.recordstatus = 1  and taxcode like '%".(isset($_REQUEST['taxcode'])?$_REQUEST['taxcode']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'taxid', 'taxcode','taxvalue','description'
        ),
				'defaultOrder' => array( 
