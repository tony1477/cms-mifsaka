<?php
	$sqldata="select b.companyname,a.genjournalid,journalno,journaldate,postdate
		from genjournal a 
		join company b on b.companyid = a.companyid 
		where recordstatus = 3
		and journalno like '%".(isset($_REQUEST['journalno'])?$_REQUEST['journalno']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'journalno':$("input[name='<?php echo $this->ColField; ?>_search_journalno']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_journalno"><?php echo $this->getCatalog('journalno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_journalno" class="form-control">
					<span class="input-group-btn">
