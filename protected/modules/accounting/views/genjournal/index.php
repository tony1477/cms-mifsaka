      ...
      <div class="modal-body">
        ...
        <div class="row">
						...
						<div class="col-md-8">
							...
							<input type="hidden" class="form-control" name="genjournal_0_recordstatus">
