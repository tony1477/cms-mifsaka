<script src="<?php echo Yii::app()->baseUrl;?>/js/cb.js"></script>
<h3><?php echo $this->getCatalog('cb') ?></h3>
<?php if ($this->checkAccess('cb','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('cb','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('cb','isreject')) { ?>
...
<div id="SearchDialog" class="modal fade" role="dialog">
	<div class="modal-dialog">
        ...
        <h4 class="modal-title"><?php echo $this->getCatalog('search') ?></h4>
          ...
          <div class="form-group">
						<label for="dlg_search_chequeno"><?php echo $this->getCatalog('chequeno')?></label>
						<input type="text" class="form-control" name="dlg_search_chequeno">
					</div>
          <div class="form-group">
