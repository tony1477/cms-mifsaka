	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/paymenttarget/createpaymenttargetdet')?>','data':{},
		...
		'success':function(data) {
			if (data.status == "success")
			{
                ...
                $("input[name='paymenttargetdet_1_custcategoryid']").val('');
                $("input[name='paymenttargetdet_1_custcategoryname']").val('');
                $("input[name='paymenttargetdet_1_addressbookid']").val('');
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/paymenttarget/updatepaymenttargetdet')?>','data':{'id':$id},
		...
		'success':function(data) {
			if (data.status == "success")
			{
                ...
                $("input[name='paymenttargetdet_1_custcategoryid']").val(data.custcategoryid);
                $("input[name='paymenttargetdet_1_custcategoryname']").val(data.custcategoryname);
...
function savedatapaymenttargetdet()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/paymenttarget/savepaymenttargetdet')?>',
		'data':{
            ...
            'custcategoryid':$("input[name='paymenttargetdet_1_custcategoryid']").val(),
...
<div id="InputDialogpaymenttargetdet" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'paymenttargetdet_1_custcategoryid','ColField'=>'paymenttargetdet_1_custcategoryname',
							'IDDialog'=>'paymenttargetdet_1_custcategoryid_dialog','titledialog'=>$this->getCatalog('custcategory'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'common.components.views.CustcategoryPopUp','PopGrid'=>'paymenttargetdet_1_custcategoryidgrid','onaftersign'=>'clearcustomer()')); 
					?>
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'paymenttargetdet_1_addressbookid','ColField'=>'paymenttargetdet_1_customer',
							...
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'common.components.views.CustomerCustCategoryPopUp','PopGrid'=>'paymenttargetdet_1_addressbookidgrid','RelationID'=>'paymenttargetdet_1_custcategoryid')); 
					?>
