...
function newdata()
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/create')?>','data':{},
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/createreqpayinv')?>','data':{},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
			$("input[name='reqpayinv_1_ekspedisiid']").val('');
      ...
      $("input[name='reqpayinv_1_ekspedisino']").val('');
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/update')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/updatereqpayinv')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
			$("input[name='reqpayinv_1_ekspedisiid']").val(data.ekspedisiid);
      ...
      $("input[name='reqpayinv_1_ekspedisino']").val(data.ekspedisino);
...
function savedata()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/save')?>',
		'data':{
...
function savedatareqpayinv()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/savereqpayinv')?>',
		'data':{
			'reqpayid':$("input[name='reqpay_0_reqpayid']").val(),
			'ekspedisiid':$("input[name='reqpayinv_1_ekspedisiid']").val(),
...
function approvedata($id)
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/approve')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){	
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/delete')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/purge')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('accounting/reqpayex/purgereqpayinv')?>','data':{'id':$.fn.yiiGridView.getSelection("reqpayinvList")},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
+ '&reqpayno='+$("input[name='dlg_search_reqpayno']").val()
+ '&headernote='+$("input[name='dlg_search_headernote']").val();
	window.open('<?php echo Yii::app()->createUrl('Accounting/reqpayex/downpdf')?>?'+array);
}
...
+ '&reqpayno='+$("input[name='dlg_search_reqpayno']").val()
+ '&headernote='+$("input[name='dlg_search_headernote']").val();
	window.open('<?php echo Yii::app()->createUrl('Accounting/reqpayex/downxls')?>?'+array);
}
...
<h3><?php echo $this->getCatalog('reqpayex') ?></h3>
<?php if ($this->checkAccess('reqpayex','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('reqpayex','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('reqpayex','isreject')) { ?>
<button name="DeleteButton" type="button" class="btn btn-warning" onclick="deletedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('reject')?></button>
<?php } ?>
<?php if ($this->checkAccess('reqpayex','ispurge')) { ?>
<button name="PurgeButton" type="button" class="btn btn-danger" onclick="purgedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('purge')?></button>
<?php } ?>
<button name="SearchButton" type="button" class="btn btn-success" data-toggle="modal" data-target="#SearchDialog"><?php echo $this->getCatalog('search')?></button>
<?php if ($this->checkAccess('reqpayex','isdownload')) { ?>
  <div class="btn-group">
			...
			(
				...
				(
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('reqpayex','iswrite')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('reqpayex','ispurge')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('reqpayex','isdownload')),
							'url'=>'"#"',
							'click'=>"function() { 
...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $this->getCatalog('reqpayex') ?></h4>
      </div>
      <div class="modal-body">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->getCatalog('reqpayinv') ?></h4>
			...
			<div class="modal-body">
			<input type="hidden" class="form-control" name="reqpayinv_1_ekspedisiid">
