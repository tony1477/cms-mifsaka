<?php
	$sqldata="select b.gireturno, b.gireturid
from giretur b  
where b.recordstatus = 3
and b.gireturno like '%".(isset($_REQUEST['gireturno'])?$_REQUEST['gireturno']:'')."%' 
 " 
;
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		...
		'gireturno':$("input[name='<?php echo $this->ColField; ?>_search_gireturno']").val()
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_gireturno"><?php echo $this->getCatalog('gireturno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_gireturno" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('giretur'),
						'name'=>'gireturid', 
