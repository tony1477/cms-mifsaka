<?php
	$sqldata="select b.grno, b.grheaderid
from grheader b  
where b.grheaderid in 
(
select a.grheaderid 
from invoiceap a 
)
and b.grno like '%".(isset($_REQUEST['grno'])?$_REQUEST['grno']:'')."%' 
 " 
;
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		...
		'grno':$("input[name='<?php echo $this->ColField; ?>_search_grno']").val()
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_grno"><?php echo $this->getCatalog('grno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_grno" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('grheader'),
						'name'=>'grheaderid', 
