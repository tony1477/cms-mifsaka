<?php
	$sqldata=" select a.poheaderid, b.fullname,a.pono,a.docdate,a.headernote
        ...
        where a.recordstatus = 5  and b.isvendor = 1
...
function update_grreturdetail1(){
    jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/grretur/updategrreturdetail1')?>',
		'data':{
            'grreturid':$("input[name='grretur_0_grreturid']").val(),
			'docdate':$("input[name='grretur_0_docdate']").val(),
