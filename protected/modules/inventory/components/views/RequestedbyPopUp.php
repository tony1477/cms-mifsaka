<?php
	$sqldata="select a.requestedbyid, a.requestedbycode, a.description
from requestedby a
		where a.recordstatus = 1 and a.requestedbycode like '%".(isset($_REQUEST['requestedbycode'])?$_REQUEST['requestedbycode']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'requestedbyid', 'requestedbycode', 'description'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'requestedbycode':$("input[name='<?php echo $this->ColField?>_search_requestedbycode']").val()
	}});
	return false;
}
...
$(document).ready(function(){
	...
	$(":input[name*='<?php echo $this->ColField; ?>_search_requestedbycode']").keyup(function(e){
	if(e.keyCode == 13)
	{
		<?php echo $this->IDField?>searchdata()
	}});
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_fullname"><?php echo $this->getCatalog('requestedbycode') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
