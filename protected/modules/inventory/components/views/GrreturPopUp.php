<?php
	$sqldata="select b.grreturno, b.grreturid
from grretur b  
where b.recordstatus = 3
and b.grreturno like '%".(isset($_REQUEST['grreturno'])?$_REQUEST['grreturno']:'')."%' 
 " 
;
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		...
		'grreturno':$("input[name='<?php echo $this->ColField; ?>_search_grreturno']").val()
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_grreturno"><?php echo $this->getCatalog('grreturno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_grreturno" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('grretur'),
						'name'=>'grreturid', 
