<?php
	$sqldata="select b.dano, b.deliveryadviceid
from deliveryadvice b  
where b.deliveryadviceid in 
(
select a.deliveryadviceid 
from transstock a 
)
and b.dano like '%".(isset($_REQUEST['dano'])?$_REQUEST['dano']:'')."%' 
 " 
;
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'deliveryadviceid', 'dano'
        ),
				'defaultOrder' => array( 
					'a.deliveryadviceid' => CSort::SORT_DESC
				),
			),
		));
		?>
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		...
		'dano':$("input[name='<?php echo $this->ColField; ?>_search_dano']").val()
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_dano"><?php echo $this->getCatalog('dano') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_dano" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('deliveryadvice'),
