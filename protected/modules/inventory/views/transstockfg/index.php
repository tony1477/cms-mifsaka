...
function newdata()
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/create')?>','data':{},
      ...
      $("input[name='transstock_0_productoutputid']").val('');
      $("input[name='transstock_0_productoutputno']").val('');
      ...
      $("input[name='transstock_0_sloctocode']").val('');
      $("input[name='transstock_0_slocfromcode']").val('');
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/createtransstockdet')?>','data':{},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstockfg/update')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
                ...
                $("input[name='transstock_0_sloctocode']").val(data.sloctocode);
                $("input[name='transstock_0_productoutputno']").val(data.productoutputno);
                $("input[name='transstock_0_productoutputid']").val(data.productoutputid);
				$.fn.yiiGridView.update('transstockdetList',{data:{'transstockid':data.transstockid}});
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstockfg/updatetransstockdet')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
      ...
      $("input[name='transstockdet_1_rakasal']").val(data.rakasal);
      $("input[name='transstockdet_1_uomcode']").val(data.uomcode);
      $("input[name='transstockdet_1_raktujuan']").val(data.raktujuan);
			$('#InputDialogtransstockdet').modal();
			}
			else
			{
...
function savedata()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstockfg/save')?>',
		'data':{
...
function savedatatransstockdet()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/savetransstockdet')?>',
		'data':{
			'transstockid':$("input[name='transstock_0_transstockid']").val(),
...
function approvedata($id)
{
    ...
    $(".ajax-loader").css("visibility", "visible");
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstockfg/approve')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){	
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstockfg/delete')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/purge')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/purgetransstockdet')?>','data':{'id':$.fn.yiiGridView.getSelection("transstockdetList")},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
+ '&sloccode='+$("input[name='dlg_search_sloccode']").val()
+ '&dano='+$("input[name='dlg_search_dano']").val();
	window.open('<?php echo Yii::app()->createUrl('Inventory/transstock/downpdf')?>?'+array);
}
...
+ '&sloccode='+$("input[name='dlg_search_sloccode']").val()
+ '&dano='+$("input[name='dlg_search_dano']").val();
	window.open('<?php echo Yii::app()->createUrl('Inventory/transstock/downxls')?>?'+array);
}
...
<h3><?php echo $this->getCatalog('transstock') ?></h3>
<?php if ($this->checkAccess('transstock','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('transstock','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('transstock','isreject')) { ?>
...
array(
					...
					'value'=>'$data["productoutputno"]'
							...
							array(
					'header'=>$this->getCatalog('slocfrom'),
					'name'=>'slocfromid',
					'value'=>'$data["slocfromcode"]'
				),
							array(
					'header'=>$this->getCatalog('slocto'),
					'name'=>'sloctoid',
					'value'=>'$data["sloctocode"]'
				),
							array(
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'transstock_0_productoutputid','ColField'=>'transstock_0_productoutputno',
							'IDDialog'=>'transstock_0_productoutputid_dialog','titledialog'=>$this->getCatalog('productoutputno'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'production.components.views.TransstockOPPopUp','PopGrid'=>'productoutputidgrid')); 
					?>
          
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'transstock_0_slocfromid','ColField'=>'transstock_0_slocfromcode',
							'IDDialog'=>'transstock_0_slocfromid_dialog','titledialog'=>$this->getCatalog('slocfrom'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'common.components.views.SlocPopUp','PopGrid'=>'transstock_0_slocfromidgrid')); 
					?>
          
           <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'transstock_0_sloctoid','ColField'=>'transstock_0_sloctocode',
							'IDDialog'=>'transstock_0_sloctoid_dialog','titledialog'=>$this->getCatalog('slocto'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
		...
		'columns'=>array(
			...
			array(
					...
					'value'=>'$data["uomcode"]'
                            ...
                            array(
					'header'=>$this->getCatalog('storagebinfrom'),
					'name'=>'storagebinid',
					'value'=>'$data["rakasal"]'
				),	
							array(
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->getCatalog('transstockdet') ?></h4>
            ...
            <div class="row">
						<div class="col-md-4">
							<label for="transstockdet_1_productname"><?php echo $this->getCatalog('product')?></label>
						</div>
						<div class="col-md-8">
							<input type="text" class="form-control" name="transstockdet_1_productname" readonly="readonly" />
						</div>
					</div>
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'transstockdet_1_storagebinid','ColField'=>'transstockdet_1_rakasal',
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'transstockdet_1_storagebintoid','ColField'=>'transstockdet_1_raktujuan',
