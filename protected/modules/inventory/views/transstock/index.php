...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/update')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
{
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/updatetransstockdet')?>','data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
			{
...
function savedata()
{
	...
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/save')?>',
		'data':{
...
function approvedata($id)
{
    ...
    $(".ajax-loader").css("visibility", "visible");
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/approve')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
...
{
	$.msg.confirmation('Confirm','<?php echo $this->getCatalog('areyousure')?>',function(){	
	jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('inventory/transstock/delete')?>',
		'data':{'id':$id},
		'type':'post','dataType':'json',
		'success':function(data) {
			if (data.status == "success")
