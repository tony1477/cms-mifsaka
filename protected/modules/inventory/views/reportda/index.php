<script src="<?php echo Yii::app()->baseUrl;?>/js/reportda.js"></script>
...
<div id="InputDialogdeliveryadvicedetail" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="row">
						<div class="col-md-4">
							<label for="deliveryadvicedetail_1_recordstatus"><?php echo $this->getCatalog('recordstatus')?></label>
						</div>
						<div class="col-md-8">
							<input type="checkbox" name="deliveryadvicedetail_1_recordstatus">
						</div>
					</div>
