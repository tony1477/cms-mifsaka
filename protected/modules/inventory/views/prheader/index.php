<script src="<?php echo Yii::app()->baseUrl;?>/js/prheader.js"></script>
<script>
...
<h3><?php echo $this->getCatalog('prheader') ?></h3>
<?php if ($this->checkAccess('prheader','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('prheader','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('prheader','isreject')) { ?>
      ...
      <div class="modal-body">
        ...
        <div class="row">
					 ...
					 <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'deliveryadviceid','ColField'=>'dano',
							'IDDialog'=>'prheaderid_dialog','titledialog'=>$this->getCatalog('deliveryadvice'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'inventory.components.views.FormrequestppPopUp','PopGrid'=>'deliveryadviceidgrid',
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->getCatalog('prmaterial') ?></h4>
			...
			<div class="modal-body">
			<input type="hidden" class="form-control" name="prmaterial_1_prmaterialid">
			<?php $this->widget('DataPopUp',
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'prmaterial_1_unitofmeasureid','ColField'=>'prmaterial_1_uomcode',
							...
							'classtypebox'=>'col-md-8','RelationID'=>'prmaterial_1_productid',
							'PopUpName'=>'common.components.views.UomPlantPopUp','PopGrid'=>'prmaterial_1_unitofmeasureidgrid')); 
					?>
