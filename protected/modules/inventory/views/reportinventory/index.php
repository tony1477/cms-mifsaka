...
+ '&customer='+$("input[name='customername']").val()
...
<div class="row">
	...
	<div class="col-md-8">
        ...
        <option value="43">45.Laporan Harian</option>                    
					...
					?>
                        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'addressbookid','ColField'=>'customername',
							'IDDialog'=>'addressbookid_dialog','titledialog'=>$this->getCatalog('customer'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8','RelationID'=>'companyid',
							'PopUpName'=>'common.components.views.CustomerPopUp','PopGrid'=>'addressbookgrid')); 
					?>
                        <?php $this->widget('DataPopUp',
