<script src="<?php echo Yii::app()->baseUrl;?>/js/deliveryadvicesalesorder.js"></script>
<h3><?php echo $this->getCatalog('deliveryadvicesalesorder') ?></h3>
<?php if ($this->checkAccess('deliveryadvicesalesorder','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvicesalesorder','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvicesalesorder','isreject')) { ?>
<button name="DeleteButton" type="button" class="btn btn-warning" onclick="deletedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('reject')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvicesalesorder','ispurge')) { ?>
<button name="PurgeButton" type="button" class="btn btn-danger" onclick="purgedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('purge')?></button>
<?php } ?>
<button name="SearchButton" type="button" class="btn btn-success" data-toggle="modal" data-target="#SearchDialog"><?php echo $this->getCatalog('search')?></button>
<?php if ($this->checkAccess('deliveryadvicesalesorder','isdownload')) { ?>
  <div class="btn-group">
			...
			(
				...
				(
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvicesalesorder','iswrite')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvicesalesorder','ispurge')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvicesalesorder','isdownload')),
							'url'=>'"#"',
							'click'=>"function() { 
...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $this->getCatalog('deliveryadvicesalesorder') ?></h4>
      </div>
      <div class="modal-body">
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'deliveryadvice_0_soheaderid','ColField'=>'deliveryadvice_0_sono',
							'IDDialog'=>'deliveryadvice_0_soheaderid_dialog','titledialog'=>$this->getCatalog('sono'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'order.components.views.SoUserPopUp','PopGrid'=>'deliveryadvice_0_soheaderidgrid',
							'onaftersign'=>'generateso();')); 
					?>
