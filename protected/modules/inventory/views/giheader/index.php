<script src="<?php echo Yii::app()->baseUrl;?>/js/giheader.js"></script>
<h3><?php echo $this->getCatalog('giheader') ?></h3>
<?php if ($this->checkAccess('giheader','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('giheader','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('giheader','isreject')) { ?>
...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<div class="row">
				<div class="col-md-4">
					<label for="giheader_0_gidate"><?php echo $this->getCatalog('gidate')?></label>
				</div>
				<div class="col-md-8">
					<input type="date" class="form-control" name="giheader_0_gidate">
				</div>
			</div>
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'giheader_0_soheaderid','ColField'=>'giheader_0_sono',
							...
							'PopUpName'=>'order.components.views.SoUserPopUp','PopGrid'=>'giheader_0_soheaderidgrid')); 
					?>
