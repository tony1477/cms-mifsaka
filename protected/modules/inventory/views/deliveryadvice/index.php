<script src="<?php echo Yii::app()->baseUrl;?>/js/deliveryadvice.js"></script>
<script>
...
<h3><?php echo $this->getCatalog('deliveryadvice') ?></h3>
<?php if ($this->checkAccess('deliveryadvice','iswrite')) { ?>
<button name="CreateButton" type="button" class="btn btn-primary" onclick="newdata()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvice','ispost')) { ?>
<button name="ApproveButton" type="button" class="btn btn-success" onclick="approvedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('approve')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvice','isreject')) { ?>
<button name="DeleteButton" type="button" class="btn btn-warning" onclick="deletedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('reject')?></button>
<?php } ?>
<?php if ($this->checkAccess('deliveryadvice','ispurge')) { ?>
<button name="PurgeButton" type="button" class="btn btn-danger" onclick="purgedata($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('purge')?></button>
<?php } ?>
<button name="SearchButton" type="button" class="btn btn-success" data-toggle="modal" data-target="#SearchDialog"><?php echo $this->getCatalog('search')?></button>
<?php if ($this->checkAccess('deliveryadvice','isdownload')) { ?>
  <div class="btn-group">
			...
			(
				...
				(
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvice','iswrite')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvice','ispurge')),							
							'url'=>'"#"',
							'click'=>"function() { 
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('deliveryadvice','isdownload')),
							'url'=>'"#"',
							'click'=>"function() { 
...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $this->getCatalog('deliveryadvice') ?></h4>
      </div>
      <div class="modal-body">
				<input type="hidden" class="form-control" name="deliveryadvice_0_deliveryadviceid">
				<div class="row">
						<div class="col-md-4">
							<label for="deliveryadvice_0_dadate"><?php echo $this->getCatalog('docdate')?></label>
						</div>
						<div class="col-md-8">
							<input type="date" class="form-control" name="deliveryadvice_0_dadate">
						</div>
					</div>
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'deliveryadvice_0_slocid','ColField'=>'deliveryadvice_0_sloccode',
							'IDDialog'=>'deliveryadvice_0_slocid_dialog','titledialog'=>$this->getCatalog('slocfrom'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'common.components.views.SlocComSlocPopUp','PopGrid'=>'deliveryadvice_0_slocidgrid')); 
					?>
      ...
      <div class="modal-header">
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'deliveryadvicedetail_1_slocid','ColField'=>'deliveryadvicedetail_1_sloccode',
							'IDDialog'=>'deliveryadvicedetail_1_slocid_dialog','titledialog'=>$this->getCatalog('slocto'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
