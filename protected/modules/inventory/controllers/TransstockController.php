...
class TransstockController extends AdminController
{
	protected $menuname = 'transstock';
	public $module = 'Inventory';
	protected $pageTitle = 'Transfer Gudang Keluar';
	public $wfname = 'appts';
...
protected $sqlcounttransstockdet = "select count(1) 
  ...
  ";
	...
	protected function getSQL()
	{
		...
		$where = "where a0.recordstatus in (".getUserRecordStatus('listts').") 
				and a0.slocfromid in (".getUserObjectValues('sloc').")";
