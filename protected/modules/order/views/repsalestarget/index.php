...
<?php if ($this->checkAccess('salestarget','isdownload')) { ?>
  <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
      ...
      <li><a onclick="downpdfrekap($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('downpdfrekap')?></a></li>
      <li><a onclick="downxlsrekap($.fn.yiiGridView.getSelection('GridList'))"><?php echo $this->getCatalog('downxlsrekap')?></a></li>
    </ul>
  </div>
<?php } ?>
<?php
				...
				<div class="box-body">
					<?php
					    ...
					    'ajaxUpdate'=>true,
							...
							'columns'=>array(
								array(
									'header'=>$this->getCatalog('custcaetgory'),
									'name'=>'custcategoryid',
