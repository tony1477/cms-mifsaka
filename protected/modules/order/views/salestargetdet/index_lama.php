...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
						<div class="col-md-4">
							<label for="salestarget_0_perioddate"><?php echo $this->getCatalog('perioddate')?></label>
						</div>
						<div class="col-md-8">
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'salestarget_0_employeeid','ColField'=>'salestarget_0_employeename',
							...
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'hr.components.views.EmployeecomsalesPopUp','PopGrid'=>'salestarget_0_employeeidgrid','RelationID'=>'salestarget_0_companyid','onaftersign'=>'generatedetail()')); 
					?>
...
<div id="InputDialogsalestargetdet" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <?php $this->widget('DataPopUp',
						array('id'=>'Widget','IDField'=>'salestargetdet_1_productid','ColField'=>'salestargetdet_1_productname',
							'IDDialog'=>'salestargetdet_1_productid_dialog','titledialog'=>$this->getCatalog('product'),'classtype'=>'col-md-4',
							'classtypebox'=>'col-md-8',
							'PopUpName'=>'common.components.views.ProductMatgroupPopUp','PopGrid'=>'salestargetdet_1_productidgrid','RelationID'=>'salestargetdet_1_materialgroupid',
                            'RelationID2'=>'salestarget_0_companyid','onaftersign'=>'generateproduct()')); 
					?>
