    ...
    <div class="modal-content">
      ...
      <div class="row">
        ...
        <div class="row">
				...
				<li><a data-toggle="tab" href="#salesscaledet"><?php echo $this->getCatalog("salesscaledet")?></a></li>
...
<div id="salesscaledet" class="tab-pane">
	<?php if ($this->checkAccess('salesscale','iswrite')) { ?>
<button name="CreateButtonsalesscaledet" type="button" class="btn btn-primary" onclick="newdatasalesscaledet()"><?php echo $this->getCatalog('new')?></button>
<?php } ?>
<?php if ($this->checkAccess('salesscale','ispurge')) { ?>
<button name="PurgeButtonsalesscaledet" type="button" class="btn btn-danger" onclick="purgedatasalesscaledet()"><?php echo $this->getCatalog('purge')?></button>
<?php } ?>
    <?php
	$this->widget('zii.widgets.grid.CGridView', array(
