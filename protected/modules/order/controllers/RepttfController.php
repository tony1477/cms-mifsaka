<?php class RepttfController extends AdminController
{
	protected $menuname = 'repttf';
	public $module = 'order';
	protected $pageTitle = 'Daftar Tanda Terima Faktur';
...
echo "Angka terlalu Besar";
  ...
  public function actionDownPDF()
  {
    ...
    foreach($dataReader as $row)
    {
      ...
      $this->pdf->setwidths(array(8,20,45,20,20,25,20,25));
...
$this->pdf->checkNewPage(40);
      ...
      $this->pdf->text(90,$this->pdf->gety()+53,$row['fullname']);
