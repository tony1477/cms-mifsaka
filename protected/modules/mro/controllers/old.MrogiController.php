...
protected $sqlcountmrogidetail = "select count(1) 
  ...
  ";
    ...
    $dataProvider=new CSqlDataProvider($this->sqldata,array(
			...
			'sort'=>array(
				'attributes'=>array(
					 'mrogiheaderid','mrogino','mrogidate','giheaderid','shipto','headernote','recordstatus'
				),
				'defaultOrder' => array( 
...
public function actionSave()
	{
		...
		if ($error == false)
		{
			...
			try
			{
				$sql = 'call Updatemrogi (:mrogiheaderid,:mrogidate,:giheaderid,:shipto,:headernote,:vcreatedby)';
				$command = $connection->createCommand($sql);
