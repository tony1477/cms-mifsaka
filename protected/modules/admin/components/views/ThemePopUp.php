<?php
	$sqldata="select themeid,themename,description 
		from theme 
		where recordstatus = 1 
		and themename like '%".(isset($_REQUEST['themename'])?$_REQUEST['themename']:'')."%'
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'themename':$("input[name='<?php echo $this->ColField; ?>_search_themename']").val(),
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_themename"><?php echo $this->getCatalog('themename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_themename" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('themeid'),
						'name'=>'themeid', 
						'value'=>'$data["themeid"]',
						'htmlOptions'=>array('width'=>'1%')
					),
					array(
						'header'=>$this->getCatalog('themename'),
						'name'=>'themename', 
