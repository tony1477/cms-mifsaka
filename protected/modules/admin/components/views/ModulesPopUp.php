<?php
	$sqldata="select moduleid,modulename  
		from modules 
		where recordstatus = 1 and modulename like '%".(isset($_REQUEST['modulename'])?$_REQUEST['modulename']:'')."%'";
	 ...
	 <div class="modal-content">
      ...
      <div class="modal-body">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('moduleid'),
						'name'=>'moduleid', 
						'value'=>'$data["moduleid"]',
