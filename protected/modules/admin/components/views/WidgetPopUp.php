<?php
	$sqldata="select widgetid,widgetname,widgettitle,description 
		from widget 
		where recordstatus = 1 and widgetname like '%".(isset($_REQUEST['widgetname'])?$_REQUEST['widgetname']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'widgetid', 'widgetname', 'widgettitle', 'description'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'widgetname':$("input[name='<?php echo $this->ColField; ?>_search_widgetname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_widgetname"><?php echo $this->getCatalog('widgetname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_widgetname" class="form-control">
					<span class="input-group-btn">
