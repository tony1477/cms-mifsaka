...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'wfname':$("input[name='<?php echo $this->ColField; ?>_search_wfname']").val(),
		'wfdesc':$("input[name='<?php echo $this->ColField; ?>_search_wfdesc']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_wfname"><?php echo $this->getCatalog('wfname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_wfname" class="form-control">
					<span class="input-group-btn">
			...
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_wfdesc"><?php echo $this->getCatalog('wfdesc') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_wfdesc" class="form-control">
				</div>
			</div>
			</div>
			<?php	
