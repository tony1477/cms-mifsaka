...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'menuname':$("input[name='<?php echo $this->ColField; ?>_search_menuname']").val(),
		'modulename':$("input[name='<?php echo $this->ColField; ?>_search_modulename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_menuname"><?php echo $this->getCatalog('menuname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_menuname" class="form-control">
					<span class="input-group-btn">
			...
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_modulename"><?php echo $this->getCatalog('modulename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_modulename" class="form-control">
				</div>
			</div>
			</div>
			<?php	
