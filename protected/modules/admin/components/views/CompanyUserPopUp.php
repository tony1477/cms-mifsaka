<?php
	$sqldata="select companyid,companyname  
		from company 
		where recordstatus = 1 and companyname like '%".(isset($_REQUEST['companyname'])?$_REQUEST['companyname']:'')."%'
		and companyid in (select distinct gm.menuvalueid from groupaccess c
