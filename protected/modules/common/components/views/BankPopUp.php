<?php
	$sqldata="select a.bankid,a.bankname
		from bank a  
		where a.recordstatus = 1 and a.bankname like '%".(isset($_REQUEST['bankname'])?$_REQUEST['bankname']:'')."%' 
		";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'bankname':$("input[name='<?php echo $this->ColField?>_search_bankname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_bankname"><?php echo $this->getCatalog('bankname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_bankname" class="form-control">
					<span class="input-group-btn">
