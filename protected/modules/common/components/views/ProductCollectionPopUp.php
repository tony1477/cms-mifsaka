<?php
	$sqldata="select productcollectid, collectionname, recordstatus
		from productcollection 
		where recordstatus = 1 
		and collectionname like '%".(isset($_REQUEST['collectionname'])?$_REQUEST['collectionname']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'collectionname':$("input[name='<?php echo $this->ColField; ?>_search_collectionname']").val(),
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_collectionname"><?php echo $this->getCatalog('collectionname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_collectionname" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('productcolletid'),
