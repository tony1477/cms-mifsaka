...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'materialtypecode':$("input[name='<?php echo $this->ColField; ?>_search_materialtypecode']").val(),
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_materialtypecode"><?php echo $this->getCatalog('materialtypecode') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_materialtypecode" class="form-control">
					<span class="input-group-btn">
			...
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_description"><?php echo $this->getCatalog('materialtypecode') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('materialtypeid'),
						'name'=>'materialtypeid', 
						'value'=>'$data["materialtypeid"]',
						'htmlOptions'=>array('width'=>'1%')
					),
					array(
						'header'=>$this->getCatalog('materialtypecode'),
