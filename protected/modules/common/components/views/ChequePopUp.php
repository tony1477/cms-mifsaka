<?php
	$sqldata="select a.chequeid,a.chequeno
		from cheque a 
		where a.recordstatus = 1 and a.chequeno like '%".(isset($_REQUEST['chequeno'])?$_REQUEST['chequeno']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'chequeno':$("input[name='<?php echo $this->ColField?>']_search_chequeno").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_contacttypename"><?php echo $this->getCatalog('chequeno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_contacttypename" class="form-control">
					<span class="input-group-btn">
			...
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_chequeno"><?php echo $this->getCatalog('description') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_chequeno" class="form-control">
					</div>
					</div>
			</div>
			<?php	
