<?php
	$sqldata="select a.groupcustomerid,a.groupname
		from groupcustomer a 
		where a.recordstatus = 1 and a.groupname like '%".(isset($_REQUEST['groupname'])?$_REQUEST['groupname']:'')."%'";
...
$(document).ready(function(){
	...
	$("input[name='<?php echo $this->ColField; ?>_groupname']").keyup(function(e){
	if(e.keyCode == 13)
	{
		<?php echo $this->IDField?>searchdata()
	}});
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_groupname"><?php echo $this->getCatalog('groupname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_groupname" class="form-control">
					<span class="input-group-btn">
