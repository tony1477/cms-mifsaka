<?php
	$sqldata="select a.custcategoryid,a.custcategoryname
		from custcategory a 
		where a.recordstatus = 1 and a.custcategoryname like '%".(isset($_REQUEST['custcategoryname'])?$_REQUEST['custcategoryname']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'custcategoryid', 'custcategoryname'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'custcategoryname':$("input[name='<?php echo $this->ColField?>_search_custcategoryname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_custcategoryname"><?php echo $this->getCatalog('custcategoryname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_custcategoryname" class="form-control">
					<span class="input-group-btn">
