<?php
	$sqldata="select a.materialgroupid,a.materialgroupcode,a.description 
		...
		where a.isfg = 0 and a.recordstatus = 1 and a.materialgroupcode like '%".(isset($_REQUEST['materialgroupcode'])?$_REQUEST['materialgroupcode']:'')."%' and a.groupkastaid = ".(isset($_REQUEST['groupkastaid'])?$_REQUEST['groupkastaid']:'null')."
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'groupkastaid':$("input[name='<?php echo $this->RelationID?>']").val(),
		'materialgroupcode':$("input[name='<?php echo $this->ColField?>_search_materialgroupcode']").val(),
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_materialgroupcode"><?php echo $this->getCatalog('materialgroupcode') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_materialgroupcode" class="form-control">
					<span class="input-group-btn">
