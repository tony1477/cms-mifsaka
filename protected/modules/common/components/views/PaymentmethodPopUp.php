...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'paycode':$("input[name='<?php echo $this->ColField?>_search_paycode']").val(),
		'paymentname':$("input[name='<?php echo $this->ColField?>_search_paymentname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_paycode"><?php echo $this->getCatalog('paycode') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_paycode" class="form-control">
					<span class="input-group-btn">
			...
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_search_paymentname"><?php echo $this->getCatalog('paymentname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_search_paymentname" class="form-control">
					</div>
					</div>
			</div>
			<?php	
