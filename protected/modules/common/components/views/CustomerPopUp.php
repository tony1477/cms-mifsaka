<?php
	$sqldata="select a.addressbookid,a.fullname,a.creditlimit,a.currentlimit 
		from addressbook a 
		where a.recordstatus = 1 and a.iscustomer = 1 and (a.fullname like '%".(isset($_REQUEST['fullname'])?$_REQUEST['fullname']:'')."%' or a.addressbookid like '%".(isset($_REQUEST['fullname'])?$_REQUEST['fullname']:'')."%')
		order by a.fullname";
