<?php
	$sqldata="select a.custgradeid,a.custgradename,description
		from custgrade a 
		where a.recordstatus = 1 and a.custgradename like '%".(isset($_REQUEST['custgradename'])?$_REQUEST['custgradename']:'')."%'";
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'custgradeid', 'custgradename','description'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'custgradename':$("input[name='<?php echo $this->ColField?>_search_custgradename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_custgradename"><?php echo $this->getCatalog('custgradename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_custgradename" class="form-control">
					<span class="input-group-btn">
