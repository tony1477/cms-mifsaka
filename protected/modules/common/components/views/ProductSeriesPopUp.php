<?php
	$sqldata="select productseriesid,seriescode,description,recordstatus
		from productseries 
	...
	$materialtype=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'productseriesid', 'description','recordstatus'
        ),
				'defaultOrder' => array( 
					'productseriesid' => CSort::SORT_DESC
				),
			),
		));
		?>
	 ...
	 <div class="modal-content">
      ...
      <div class="modal-body">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('productseriesid'),
						'name'=>'productseriesid', 
						'value'=>'$data["productseriesid"]',
