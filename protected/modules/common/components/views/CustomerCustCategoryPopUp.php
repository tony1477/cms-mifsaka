<?php
	$sqldata="select a.addressbookid,a.fullname,a.creditlimit,a.currentlimit 
		...
		where a.recordstatus = 1 and a.iscustomer = 1 and a.custcategoryid = ".(isset($_REQUEST['custcategoryid'])?$_REQUEST['custcategoryid']:'null')."
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
        ...
        'custcategoryid':$("input[name='<?php echo $this->RelationID?>']").val(),
	}});
	return false;
}
...
$(document).ready(function(){
	...
	$(":input[name*='<?php echo $this->ColField; ?>_search_fullname']").keyup(function(e){
	if(e.keyCode == 13)
	{
		<?php echo $this->IDField?>searchdata()
	}});
