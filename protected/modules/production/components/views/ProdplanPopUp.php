<?php
	$sqldata="select a.productplanid,a.productplanno
		...
		and a.recordstatus in (".getUserRecordStatus('listprodplan').")
				and
				a.companyid in (".getUserObjectValues('company').")
		";
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->IDField?>_search_productplanno"><?php echo $this->getCatalog('productplanno') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
