<?php
	$sqldata="select * from standardopoutput";
...
$(document).ready(function(){
	...
	$(":input[name*='<?php echo $this->ColField; ?>_search_groupname']").keyup(function(e){
	if(e.keyCode == 13)
	{
		<?php echo $this->IDField?>searchdata()
	}});
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->IDField?>_search_groupname"><?php echo $this->getCatalog('groupname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
