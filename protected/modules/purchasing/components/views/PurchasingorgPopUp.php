<?php
	$sqldata="select purchasingorgid,purchasingorgcode,description
		from purchasingorg 
		where recordstatus = 1 
		and purchasingorgcode like '%".(isset($_REQUEST['purchasingorgcode'])?$_REQUEST['purchasingorgcode']:'')."%'
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'purchasingorgid', 'purchasingorgcode', 'purchasingorgtitle', 'description'
        ),
				'defaultOrder' => array( 
	 ...
	 <div class="modal-content">
      ...
      <div class="modal-body">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('purchasingorgid'),
						'name'=>'purchasingorgid', 
						'value'=>'$data["purchasingorgid"]',
