<?php
	$sqldata="select a.religionid,a.religionname
		from religion a 
		where a.recordstatus = 1 and a.religionname like '%".(isset($_REQUEST['religionname'])?$_REQUEST['religionname']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'religionname':$("input[name='<?php echo $this->ColField?>_search_religionname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField?>_religionname"><?php echo $this->getCatalog('religionname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField?>_religionname" class="form-control">
					<span class="input-group-btn">
