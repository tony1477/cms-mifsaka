<?php
	$sqldata="select educationid,educationname 
		from education 
		where recordstatus = 1 and educationname like '%".(isset($_REQUEST['educationname'])?$_REQUEST['educationname']:'')."%'";
	$count = count(Yii::app()->db->createCommand($sqldata)->queryAll());
	$education=new CSqlDataProvider($sqldata,array(
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'educationname':$("input[name='<?php echo $this->ColField; ?>_search_educationname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_educationname"><?php echo $this->getCatalog('educationname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_educationname" class="form-control">
					<span class="input-group-btn">
