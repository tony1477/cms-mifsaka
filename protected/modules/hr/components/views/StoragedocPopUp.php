<?php
	$sqldata="select storagedocid,storagedocname 
		from storagedoc 
		where recordstatus = 1 and storagedocname like '%".(isset($_REQUEST['storagedocname'])?$_REQUEST['storagedocname']:'')."%'";
	$count = count(Yii::app()->db->createCommand($sqldata)->queryAll());
	$storagedoc=new CSqlDataProvider($sqldata,array(
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'storagedocname':$("input[name='<?php echo $this->ColField; ?>_search_storagedocname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_storagedocname"><?php echo $this->getCatalog('storagedocname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_storagedocname" class="form-control">
					<span class="input-group-btn">
