<?php
	$sqldata="select splettertypeid,splettername,description
		from splettertype 
		where splettername like '%".(isset($_REQUEST['splettername'])?$_REQUEST['splettername']:'')."%'";
	...
	$employee=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'splettertypeid', 'splettername','description'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'splettername':$("input[name='<?php echo $this->ColField; ?>_search_splettername']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_splettername"><?php echo $this->getCatalog('splettername') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_splettername" class="form-control">
					<span class="input-group-btn">
