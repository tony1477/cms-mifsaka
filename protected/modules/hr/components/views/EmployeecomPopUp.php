<?php
	$sqldata="select distinct a.employeeid,a.fullname 
		from employee a
		left join employeeorgstruc d on d.employeeid = a.employeeid
		left join orgstructure e on e.orgstructureid = d.orgstructureid
		inner join company b on b.companyid = e.companyid
		inner join addressbook c on c.addressbookid = a.addressbookid
