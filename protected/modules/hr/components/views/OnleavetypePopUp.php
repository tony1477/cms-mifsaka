<?php
	$sqldata="select onleavetypeid,onleavename 
		from onleavetype 
		where onleavename like '%".(isset($_REQUEST['onleavename'])?$_REQUEST['onleavename']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'onleavename':$("input[name='<?php echo $this->ColField; ?>_search_onleavename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_onleavename"><?php echo $this->getCatalog('onleavename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_onleavename" class="form-control">
					<span class="input-group-btn">
