<?php
	$sqldata="select gradeid,gradename 
		from grade 
		where recordstatus = 1 and gradename like '%".(isset($_REQUEST['gradename'])?$_REQUEST['gradename']:'')."%'";
	$count = count(Yii::app()->db->createCommand($sqldata)->queryAll());
	$grade=new CSqlDataProvider($sqldata,array(
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'gradename':$("input[name='<?php echo $this->ColField; ?>_search_gradename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_gradename"><?php echo $this->getCatalog('gradename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_gradename" class="form-control">
					<span class="input-group-btn">
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'columns'=>array(
					array(
						'header'=>$this->getCatalog('gradeid'),
						'name'=>'gradeid', 
						'value'=>'$data["gradeid"]',
						'htmlOptions'=>array('width'=>'1%')
					),
					array(
						'header'=>$this->getCatalog('gradename'),
						'name'=>'gradename', 
