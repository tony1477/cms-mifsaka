<?php
	$sqldata="SELECT DISTINCT a.empplanno, a.empplanid, a.empplanname, c.username FROM empplan a 
            JOIN empplandetail b ON a.empplanid = b.empplanid
            JOIN useraccess c ON c.username = a.useraccess
            WHERE a.recordstatus NOT IN ('0','1')";
