<?php
	$sqldata="select distinct a.employeestatusid,a.employeestatusname, a.taxvalue
	...
	$product=new CSqlDataProvider($sqldata,array(
			...
			'sort'=>array(
        'attributes'=>array(
             'employeestatusid', 'employeestatusname', 'taxvalue'
        ),
				'defaultOrder' => array( 
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'employeestatusname':$("input[name='<?php echo $this->IDField?>_search_employeestatusname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->IDField?>_search_employeestatusname"><?php echo $this->getCatalog('employeestatusname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->IDField?>_search_employeestatusname" class="form-control">
					<span class="input-group-btn">
