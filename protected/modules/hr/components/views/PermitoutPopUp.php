<?php
	$sqldata="select permitexitid,permitexitname
		from permitexit 
		where permitexitname like '%".(isset($_REQUEST['permitexitname'])?$_REQUEST['permitexitname']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'permitexitname':$("input[name='<?php echo $this->ColField; ?>_search_permitexitname']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_permitexitname"><?php echo $this->getCatalog('permitexitname') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_permitexitname" class="form-control">
					<span class="input-group-btn">
