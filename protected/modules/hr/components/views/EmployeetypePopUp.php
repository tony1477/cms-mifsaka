<?php
	$sqldata="select employeetypeid,employeetypename 
		from employeetype 
		where recordstatus = 1 and employeetypename like '%".(isset($_REQUEST['employeetypename'])?$_REQUEST['employeetypename']:'')."%'";
...
function <?php echo $this->IDField?>searchdata()
{
	$.fn.yiiGridView.update("<?php echo $this->PopGrid?>",{data:{
		'employeetypename':$("input[name='<?php echo $this->ColField; ?>_search_employeetypename']").val()
	}});
	return false;
}
	...
	<div class="modal-dialog modal-lg">	
	 <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="row">
			<div class="col-md-4">
				<label class="control-label" for="<?php echo $this->ColField; ?>_search_employeetypename"><?php echo $this->getCatalog('employeetypename') ?></label>
			</div>
			<div class="col-md-8">
				<div class="input-group">
					<input type="text" name="<?php echo $this->ColField; ?>_search_employeetypename" class="form-control">
					<span class="input-group-btn">
