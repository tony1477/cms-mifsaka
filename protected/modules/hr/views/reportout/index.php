...
function searchdata($id=0)
{
	...
	var array = 'reportout_0_reportoutid='+$id
...
+ '&year='+$("input[name='dlg_search_year']").val()
	...
	window.open('<?php echo Yii::app()->createUrl('Hr/reportout/downpdf')?>?'+array);
}
...
+ '&month='+$("input[name='dlg_search_month']").val()
+ '&year='+$("input[name='dlg_search_year']").val()
	window.open('<?php echo Yii::app()->createUrl('Hr/reportout/downxls')?>?'+array);
}

function GetDetail($id)
{
	$('#ShowDetailDialog').modal('show');
	var array = 'reportoutid='+$id
} 
</script>
<h3><?php echo $this->getCatalog('reportout') ?></h3>


<button name="SearchButton" type="button" class="btn btn-success" data-toggle="modal" data-target="#SearchDialog"><?php echo $this->getCatalog('search')?></button>
<?php if ($this->checkAccess('reportout','isdownload')) { ?>
  <div class="btn-group">
			...
			(
				...
				(
					...
					(
							...
							'visible'=>$this->booltostr($this->checkAccess('reportout','isdownload')),
							'url'=>'"#"',
							'click'=>"function() { 
...
array(
					'header'=>$this->getCatalog('reportoutid'),
					'name'=>'reportoutid',
					'value'=>'$data["reportoutid"]'
				),
							array(
...
<div id="InputDialog" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title"><?php echo $this->getCatalog('reportout') ?></h4>
      </div>
      <div class="modal-body">
