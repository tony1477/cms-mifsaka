...
and a0.year like '%". $_REQUEST['year']."%'"; 
		...
		if (isset($_REQUEST['reportoutid']))
			{
				if (($_REQUEST['reportoutid'] !== '0') && ($_REQUEST['reportoutid'] !== ''))
				{
					if ($where == "")
					{
						$where .= " where a0.reportoutid in (".$_REQUEST['reportoutid'].")";
					}
					else
					{
						$where .= " and a0.reportoutid in (".$_REQUEST['reportoutid'].")";
					}
				}
			}
    ...
    $dataProvider=new CSqlDataProvider($this->sqldata,array(
			...
			'sort'=>array(
				'attributes'=>array(
					 'reportoutid','employeeid','fullname','oldnik','fulldivision','month','year','s1','d1','s2','d2','s3','d3','s4','d4','s5','d5','s6','d6','s7','d7','s8','d8','s9','d9','s10','d10','s11','d11','s12','d12','s13','d13','s14','d14','s15','d15','s16','d16','s17','d17','s18','d18','s19','d19','s20','d20','s21','d21','s22','d22','s23','d23','s24','d24','s25','d25','s26','d26','s27','d27','s28','d28','s29','d29','s30','d30','s31','d31'
				),
				'defaultOrder' => array( 
					'reportoutid' => CSort::SORT_DESC
				),
			),
		));
